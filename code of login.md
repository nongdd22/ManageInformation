...
.login-box{width:420px;margin:120px auto 0 auto;text-align:center;padding:30px;background:url(img/mask.png);border-radius:10px;}
...
<div class="login-box">
	...
	<form method="post" action="checkin.jsp">
		...
		<div class="password">
			<label>密  码：</label>
			<input type="password" name="password"  value="admin" maxlength="16" tabindex="2"/>
		</div>
		

		<div class="remember">
			<input type="checkbox" name="remember" checked="checked" tabindex="4">
			<label>记住密码</label>
		</div>
		<div class="login">
...
<div class="bottom">©2015 管理信息系统 </div>
