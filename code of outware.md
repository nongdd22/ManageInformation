...
<div id="my_menu" class="sdmenu">
	...
	<div class="collapsed">
		<span>快件查询</span>
		<a href="查询页面.html">收件查询</a>
		<a href="分理处发货排行榜.html">问题快件</a>
	</div>
	...
	$(".left").toggle();
     ...
     <div class="right_cont">
		<ul class="breadcrumb">当前位置：
		  ...
		  <a href="#">出库管理</a> <span class="divider">/</span>
		     登记出库
		</ul>

   <div class="title_right"><strong>出库清单</strong></div>  
   <div style="width:900px; margin:auto">
     <table width="101%" class="table table-bordered">
           <tr>
             ...
             <td width="8%" align="right" bgcolor="#f1f1f1">出库日期：</td>
     		<td><input type="text"  class="laydate-icon span1-1" id="Calendar" value="2015-08-25"    /></td>
           <td><input name="button" type="button" class="btn btn-info  " style="width:80px;" value="确定" />
             </td>
           </tr>
         </table>
 </table>
       <table class="table table-bordered">
         <tr>
           ...
           <td align="center" nowrap="nowrap" bgcolor="#f1f1f1"><strong>出库时间</strong></td>
           <td align="center" nowrap="nowrap" bgcolor="#f1f1f1"><strong>发往区域</strong></td>
